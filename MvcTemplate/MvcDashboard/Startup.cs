...
using MvcTemplate.Infrastructure.ApplicationUserClaims;
using MvcTemplate.Infrastructure.AppSettingsModels;
using MvcTemplate.Infrastructure.Startup;
...
namespace MvcTemplate
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Cookie.Name = "Mvc.DotNetCore.AppCookie";
            ...
            services.AddSession(options =>
            {
                ...
                options.Cookie.Name = "Mvc.DotNetCore.DotNetCore.SessionCookie";
                // You might want to only set the application cookies over a secure connection:
                // options.Cookie.SecurePolicy = CookieSecurePolicy.Always;
                options.Cookie.SameSite = SameSiteMode.Strict;
                options.Cookie.HttpOnly = true;
